...
ALTER TABLE return_request_images ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Service role full access on return_requests"
    ON return_requests FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Service role full access on return_request_items"
    ON return_request_items FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Service role full access on return_request_images"
    ON return_request_images FOR ALL USING (true) WITH CHECK (true);
